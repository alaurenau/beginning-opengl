...
m_lightPosZ(0.0f)
{
    m_GLSLProgram = new GLSLProgram("data/point_light.vert", "data/point_light.frag");
}
...
void Example::render()
{
    ...
    m_GLSLProgram->sendUniform("material_specular", 1.0f, 1.0f, 0.0f, 1.0f);
    ...
    m_GLSLProgram->sendUniform("light0.position", 0.0f, 18.0f, m_lightPosZ, 1.0f);
