...
short SimpleGLXWindow::m_keys[XK_ydiaeresis + 1];
...
float SimpleGLXWindow::getCurrentTime()
{
...
bool SimpleGLXWindow::create(int width, int height, int bpp, bool fullscreen)
{
    ...
    string title = "BOGLGP - Chapter 4 - Projections";
...
void SimpleGLXWindow::processEvents()
{
    ...
    while (XPending(m_display) > 0)
    {
        ...
        case KeyPress:
        {
            ...
            m_keys[(int)XLookupKeysym(&event.xkey,0)] = 1;
        }
        break;
        case KeyRelease:
        {
            m_keys[(int)XLookupKeysym(&event.xkey,0)] = 0;
        }
        break;
